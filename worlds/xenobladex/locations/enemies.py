...
Data("HH100: Hierana - Chp 11: Mia is Missing", depends=["Mia is Missing"]),
Data("Briggs - Chp 5: The Celeste Three", depends=["The Celeste Three"]),
Data("Fosdyke - Chp 5: The Celeste Three", depends=["The Celeste Three"]),
Data("Moorehouse - Chp 5: The Celeste Three", depends=["The Celeste Three"]),
Data("Cross Qmoeva - Chp 6: Frontier Spirit", depends=["Frontier Spirit"]),
Data("Lightning Strike - Chp 9: The Line of Fire", depends=["Line of Fire"]),
Data("Lineage - Chp 8: Shotgun Diplomacy", depends=["Shotgun Diplomacy"]),  # Accessbile earlier but missable
Data("Brutal Prone - Chp 6: Predator and Prey", depends=["Predator and Prey"]),
Data("Blood Despair - Chp 11: Rise of the Blood Lobster", depends=["Rise of the Blood Lobster", "Definian Downfall"]),
