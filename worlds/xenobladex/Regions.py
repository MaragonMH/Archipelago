...
def init_region(world, region_name: str) -> None:
...
def add_region_location(world, region_name: str, location: Location) -> Location:
    region = world.get_region(region_name)
    region.locations += [location]
    return location


def connect_regions(world, source: str, target: str, rule):
