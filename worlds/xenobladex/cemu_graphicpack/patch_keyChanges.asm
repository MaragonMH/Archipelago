...
_checkType:
	...
	lwz r9,8(r31)
	cmpwi cr0,r9,0
	ble cr0,_keyChanges_L141
	lwz r9,8(r31)
	cmpwi cr0,r9,5
	bgt cr0,_keyChanges_L141
	lis r9,disableGroundArmor@ha
	lwz r9,disableGroundArmor@l(r9)
	b _keyChanges_L142
_keyChanges_L141:
	lwz r9,8(r31)
	cmpwi cr0,r9,5
	ble cr0,_keyChanges_L143
	lwz r9,8(r31)
	cmpwi cr0,r9,7
	bgt cr0,_keyChanges_L143
	lis r9,disableGroundWeapons@ha
	lwz r9,disableGroundWeapons@l(r9)
	b _keyChanges_L142
_keyChanges_L143:
	lwz r9,8(r31)
	cmpwi cr0,r9,9
	ble cr0,_keyChanges_L144
	lwz r9,8(r31)
	cmpwi cr0,r9,14
	bgt cr0,_keyChanges_L144
	lis r9,disableSkellArmor@ha
	lwz r9,disableSkellArmor@l(r9)
	b _keyChanges_L142
_keyChanges_L144:
	lwz r9,8(r31)
	cmpwi cr0,r9,14
	ble cr0,_keyChanges_L145
	lwz r9,8(r31)
	cmpwi cr0,r9,19
	bgt cr0,_keyChanges_L145
	lis r9,disableSkellWeapons@ha
	lwz r9,disableSkellWeapons@l(r9)
	b _keyChanges_L142
_keyChanges_L145:
	lwz r9,8(r31)
	cmpwi cr0,r9,19
	ble cr0,_keyChanges_L146
	lwz r9,8(r31)
	cmpwi cr0,r9,21
	bgt cr0,_keyChanges_L146
	lis r9,disableGroundAugments@ha
	lwz r9,disableGroundAugments@l(r9)
	b _keyChanges_L142
_keyChanges_L146:
	lwz r9,8(r31)
	cmpwi cr0,r9,21
	ble cr0,_keyChanges_L147
	lwz r9,8(r31)
	cmpwi cr0,r9,24
	bgt cr0,_keyChanges_L147
	lis r9,disableSkellAugments@ha
	lwz r9,disableSkellAugments@l(r9)
	b _keyChanges_L142
_keyChanges_L147:
...
_keyChanges_L149:
	lwz r9,8(r31)
	cmpwi cr0,r9,23
	ble cr0,_keyChanges_L150
	lwz r9,8(r31)
	cmpwi cr0,r9,28
	beq cr0,_keyChanges_L150
	li r9,1
	b _keyChanges_L142
_keyChanges_L150:
	li r9,0
...
_getFlagValAdjusted:
	...
	mr r9,r30
	cmpwi cr0,r9,2
	bne cr0,_keyChanges_L165
	lwz r9,16(r31)
	cmpwi cr0,r9,246
	beq cr0,_keyChanges_L166
	lwz r9,16(r31)
	cmpwi cr0,r9,251
	beq cr0,_keyChanges_L166
	lwz r9,16(r31)
...
_keyChanges_L168:
	mr r9,r30
	cmpwi cr0,r9,7
	bne cr0,_keyChanges_L170
	lwz r9,16(r31)
	cmpwi cr0,r9,32
	beq cr0,_keyChanges_L171
	lwz r9,16(r31)
	cmpwi cr0,r9,33
	beq cr0,_keyChanges_L171
	lwz r9,16(r31)
...
_keyChanges_L170:
	mr r9,r30
	cmpwi cr0,r9,7
	bne cr0,_keyChanges_L172
	lwz r9,16(r31)
	cmpwi cr0,r9,287
	beq cr0,_keyChanges_L173
	lwz r9,16(r31)
	cmpwi cr0,r9,288
	beq cr0,_keyChanges_L173
	lwz r9,16(r31)
...
_keyChanges_L172:
	mr r9,r30
	cmpwi cr0,r9,7
	bne cr0,_keyChanges_L174
	lwz r9,16(r31)
	cmpwi cr0,r9,550
	beq cr0,_keyChanges_L175
	lwz r9,16(r31)
	cmpwi cr0,r9,551
	beq cr0,_keyChanges_L175
	lwz r9,16(r31)
...
_keyChanges_L174:
	mr r9,r30
	cmpwi cr0,r9,7
	bne cr0,_keyChanges_L176
	lwz r9,16(r31)
	cmpwi cr0,r9,810
	beq cr0,_keyChanges_L177
	lwz r9,16(r31)
	cmpwi cr0,r9,811
	beq cr0,_keyChanges_L177
	lwz r9,16(r31)
