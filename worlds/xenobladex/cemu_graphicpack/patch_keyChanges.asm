...
_keyChanges_L3:
	mr r9,r6
	cmpwi cr0,r9,1
	ble cr0,_keyChanges_L4
	mr r9,r6
	cmpwi cr0,r9,4
	bgt cr0,_keyChanges_L4
...
reqMenuAddAugmentFromIdAdjusted:
	...
	lwz r9,8(r31)
	cmpwi cr0,r9,20
	beq cr0,_keyChanges_L26
	lwz r9,8(r31)
	cmpwi cr0,r9,21
	bne cr0,_keyChanges_L27
_keyChanges_L26:
	lis r9,includeShopAugments@ha
	lwz r9,includeShopAugments@l(r9)
	cmpwi cr0,r9,0
...
reqMenuAddShopItemFromIdAdjusted:
	...
	lwz r9,8(r31)
	cmpwi cr0,r9,0
	ble cr0,_keyChanges_L42
	lwz r9,8(r31)
	cmpwi cr0,r9,5
	bgt cr0,_keyChanges_L42
	lis r9,includeShopArmor@ha
	lwz r9,includeShopArmor@l(r9)
	cmpwi cr0,r9,0
...
_keyChanges_L42:
	lwz r9,8(r31)
	cmpwi cr0,r9,5
	ble cr0,_keyChanges_L44
	lwz r9,8(r31)
	cmpwi cr0,r9,7
	bgt cr0,_keyChanges_L44
	lis r9,includeShopWeapons@ha
	lwz r9,includeShopWeapons@l(r9)
	cmpwi cr0,r9,0
...
_keyChanges_L44:
	lwz r9,8(r31)
	cmpwi cr0,r9,9
	ble cr0,_keyChanges_L45
	lwz r9,8(r31)
	cmpwi cr0,r9,14
	bgt cr0,_keyChanges_L45
	lis r9,includeShopSkellArmor@ha
	lwz r9,includeShopSkellArmor@l(r9)
	cmpwi cr0,r9,0
...
_keyChanges_L45:
	lwz r9,8(r31)
	cmpwi cr0,r9,14
	ble cr0,_keyChanges_L46
	lwz r9,8(r31)
	cmpwi cr0,r9,19
	bgt cr0,_keyChanges_L46
	lis r9,includeShopSkellWeapons@ha
	lwz r9,includeShopSkellWeapons@l(r9)
	cmpwi cr0,r9,0
...
_getDefaultSkellWeapon:
	...
	lwz r9,20(r31)
	cmpwi cr0,r9,0
	bne cr0,_keyChanges_L62
	lis r9,0x2
	b _keyChanges_L63
_keyChanges_L62:
	lwz r9,20(r31)
	cmpwi cr0,r9,1
	bne cr0,_keyChanges_L64
	lis r9,0x1
	b _keyChanges_L63
_keyChanges_L64:
	li r9,0
...
_checkType:
	...
	lwz r9,8(r31)
	cmpwi cr0,r9,0
	ble cr0,_keyChanges_L96
	lwz r9,8(r31)
	cmpwi cr0,r9,5
	bgt cr0,_keyChanges_L96
	lis r9,disableGroundArmor@ha
	lwz r9,disableGroundArmor@l(r9)
	b _keyChanges_L97
_keyChanges_L96:
	lwz r9,8(r31)
	cmpwi cr0,r9,5
	ble cr0,_keyChanges_L98
	lwz r9,8(r31)
	cmpwi cr0,r9,7
	bgt cr0,_keyChanges_L98
	lis r9,disableGroundWeapons@ha
	lwz r9,disableGroundWeapons@l(r9)
	b _keyChanges_L97
_keyChanges_L98:
	lwz r9,8(r31)
	cmpwi cr0,r9,9
	ble cr0,_keyChanges_L99
	lwz r9,8(r31)
	cmpwi cr0,r9,14
	bgt cr0,_keyChanges_L99
	lis r9,disableSkellArmor@ha
	lwz r9,disableSkellArmor@l(r9)
	b _keyChanges_L97
_keyChanges_L99:
	lwz r9,8(r31)
	cmpwi cr0,r9,14
	ble cr0,_keyChanges_L100
	lwz r9,8(r31)
	cmpwi cr0,r9,19
	bgt cr0,_keyChanges_L100
	lis r9,disableSkellWeapons@ha
	lwz r9,disableSkellWeapons@l(r9)
	b _keyChanges_L97
_keyChanges_L100:
...
_keyChanges_L101:
	lwz r9,8(r31)
	cmpwi cr0,r9,21
	ble cr0,_keyChanges_L102
	lwz r9,8(r31)
	cmpwi cr0,r9,24
	bgt cr0,_keyChanges_L102
	lis r9,disableSkellAugments@ha
	lwz r9,disableSkellAugments@l(r9)
	b _keyChanges_L97
_keyChanges_L102:
...
_getFlagValAdjusted:
	...
	mr r9,r30
	cmpwi cr0,r9,2
	bne cr0,_keyChanges_L120
	lwz r9,16(r31)
	cmpwi cr0,r9,246
	beq cr0,_keyChanges_L121
	lwz r9,16(r31)
	cmpwi cr0,r9,251
	beq cr0,_keyChanges_L121
	lwz r9,16(r31)
...
_keyChanges_L127:
	mr r9,r30
	cmpwi cr0,r9,7
	bne cr0,_keyChanges_L129
	lwz r9,16(r31)
	cmpwi cr0,r9,550
	beq cr0,_keyChanges_L130
	lwz r9,16(r31)
	cmpwi cr0,r9,551
	beq cr0,_keyChanges_L130
	lwz r9,16(r31)
