...
_keyChanges_L54:
	...
	mr r1,r11
	blr
isSellItemByMakerArmorPreAdjusted:
	stwu r1,-80(r1)
	mflr r0
	stw r0,84(r1)
	stw r20,32(r1)
...
_keyChanges_L59:
	...
	mr r1,r11
	blr
isSellItemByMakerArmorAdjusted:
	stwu r1,-64(r1)
	mflr r0
	stw r0,68(r1)
	stw r22,24(r1)
...
_keyChanges_L64:
	...
	mr r1,r11
	blr
isSellItemByMakerWeaponPreAdjusted:
	stwu r1,-80(r1)
	mflr r0
	stw r0,84(r1)
	stw r20,32(r1)
...
_keyChanges_L69:
	...
	mr r1,r11
	blr
isSellItemByMakerWeaponAdjusted:
	stwu r1,-64(r1)
	mflr r0
	stw r0,68(r1)
	stw r23,28(r1)
...
_keyChanges_L74:
	...
	mr r1,r11
	blr
isSellItemByMakerDollArmorPreAdjusted:
	stwu r1,-80(r1)
	mflr r0
	stw r0,84(r1)
	stw r20,32(r1)
...
_keyChanges_L79:
	...
	mr r1,r11
	blr
isSellItemByMakerDollArmorAdjusted:
	stwu r1,-80(r1)
	mflr r0
	stw r0,84(r1)
	stw r21,36(r1)
...
_keyChanges_L84:
	...
	mr r1,r11
	blr
isSellItemByMakerDollWeaponPreAdjusted:
	stwu r1,-80(r1)
	mflr r0
	stw r0,84(r1)
	stw r20,32(r1)
...
_keyChanges_L89:
	...
	mr r1,r11
	blr
isSellItemByMakerDollWeaponAdjusted:
	stwu r1,-64(r1)
	mflr r0
	stw r0,68(r1)
	stw r25,36(r1)
...
_keyChanges_L94:
	...
	mr r1,r11
	blr
isSellDollAssetItemByMakerDollFramePreAdjusted:
	stwu r1,-64(r1)
	mflr r0
	stw r0,68(r1)
	stw r23,28(r1)
...
_keyChanges_L99:
	...
	mr r1,r11
	blr
isSellDollAssetItemByMakerDollFrameAdjusted:
	stwu r1,-80(r1)
	mflr r0
	stw r0,84(r1)
	stw r20,32(r1)
...
_getDefaultSkellWeapon:
	...
	lwz r9,20(r31)
	cmpwi cr0,r9,0
	bne cr0,_keyChanges_L117
	lis r9,0x2
	b _keyChanges_L118
_keyChanges_L117:
	lwz r9,20(r31)
	cmpwi cr0,r9,1
	bne cr0,_keyChanges_L119
	lis r9,0x1
	b _keyChanges_L118
_keyChanges_L119:
	li r9,0
...
_Create_DataInit_Adjusted:
	...
	lwz r6,8(r31)
	li r5,4439
	lis r9,_keyChanges_LC15@ha
	addi r4,r9,_keyChanges_LC15@l
	lis r9,_keyChanges_LC16@ha
	addi r3,r9,_keyChanges_LC16@l
	bl _SetBdatValue
	bl Create_DataInit
	nop
	addi r11,r31,32
...
_checkType:
	...
	lwz r9,8(r31)
	cmpwi cr0,r9,0
	ble cr0,_keyChanges_L151
	lwz r9,8(r31)
	cmpwi cr0,r9,5
	bgt cr0,_keyChanges_L151
	lis r9,disableGroundArmor@ha
	lwz r9,disableGroundArmor@l(r9)
	b _keyChanges_L152
_keyChanges_L151:
	lwz r9,8(r31)
	cmpwi cr0,r9,5
	ble cr0,_keyChanges_L153
	lwz r9,8(r31)
	cmpwi cr0,r9,7
	bgt cr0,_keyChanges_L153
	lis r9,disableGroundWeapons@ha
	lwz r9,disableGroundWeapons@l(r9)
	b _keyChanges_L152
_keyChanges_L153:
	lwz r9,8(r31)
	cmpwi cr0,r9,9
	ble cr0,_keyChanges_L154
	lwz r9,8(r31)
	cmpwi cr0,r9,14
	bgt cr0,_keyChanges_L154
	lis r9,disableSkellArmor@ha
	lwz r9,disableSkellArmor@l(r9)
	b _keyChanges_L152
_keyChanges_L154:
	lwz r9,8(r31)
	cmpwi cr0,r9,14
	ble cr0,_keyChanges_L155
	lwz r9,8(r31)
	cmpwi cr0,r9,19
	bgt cr0,_keyChanges_L155
	lis r9,disableSkellWeapons@ha
	lwz r9,disableSkellWeapons@l(r9)
	b _keyChanges_L152
_keyChanges_L155:
	lwz r9,8(r31)
	cmpwi cr0,r9,19
	ble cr0,_keyChanges_L156
	lwz r9,8(r31)
	cmpwi cr0,r9,21
	bgt cr0,_keyChanges_L156
	lis r9,disableGroundAugments@ha
	lwz r9,disableGroundAugments@l(r9)
	b _keyChanges_L152
_keyChanges_L156:
	lwz r9,8(r31)
	cmpwi cr0,r9,21
	ble cr0,_keyChanges_L157
	lwz r9,8(r31)
	cmpwi cr0,r9,24
	bgt cr0,_keyChanges_L157
	lis r9,disableSkellAugments@ha
	lwz r9,disableSkellAugments@l(r9)
	b _keyChanges_L152
_keyChanges_L157:
...
_keyChanges_L159:
	lwz r9,8(r31)
	cmpwi cr0,r9,23
	ble cr0,_keyChanges_L160
	lwz r9,8(r31)
	cmpwi cr0,r9,28
	beq cr0,_keyChanges_L160
	li r9,1
	b _keyChanges_L152
_keyChanges_L160:
	li r9,0
...
_getFlagValAdjusted:
	...
	mr r9,r30
	cmpwi cr0,r9,2
	bne cr0,_keyChanges_L175
	lwz r9,16(r31)
	cmpwi cr0,r9,246
	beq cr0,_keyChanges_L176
	lwz r9,16(r31)
	cmpwi cr0,r9,251
	beq cr0,_keyChanges_L176
	lwz r9,16(r31)
...
_keyChanges_L175:
	mr r9,r30
	cmpwi cr0,r9,7
	bne cr0,_keyChanges_L178
	lwz r9,16(r31)
	cmpwi cr0,r9,26
	beq cr0,_keyChanges_L179
	lwz r9,16(r31)
	cmpwi cr0,r9,27
	beq cr0,_keyChanges_L179
	lwz r9,16(r31)
...
_keyChanges_L178:
	mr r9,r30
	cmpwi cr0,r9,7
	bne cr0,_keyChanges_L180
	lwz r9,16(r31)
	cmpwi cr0,r9,32
	beq cr0,_keyChanges_L181
	lwz r9,16(r31)
	cmpwi cr0,r9,33
	beq cr0,_keyChanges_L181
	lwz r9,16(r31)
...
_keyChanges_L180:
	mr r9,r30
	cmpwi cr0,r9,7
	bne cr0,_keyChanges_L182
	lwz r9,16(r31)
	cmpwi cr0,r9,287
	beq cr0,_keyChanges_L183
	lwz r9,16(r31)
	cmpwi cr0,r9,288
	beq cr0,_keyChanges_L183
	lwz r9,16(r31)
...
_keyChanges_L182:
	mr r9,r30
	cmpwi cr0,r9,7
	bne cr0,_keyChanges_L184
	lwz r9,16(r31)
	cmpwi cr0,r9,550
	beq cr0,_keyChanges_L185
	lwz r9,16(r31)
	cmpwi cr0,r9,551
	beq cr0,_keyChanges_L185
	lwz r9,16(r31)
...
_keyChanges_L184:
	mr r9,r30
	cmpwi cr0,r9,7
	bne cr0,_keyChanges_L186
	lwz r9,16(r31)
	cmpwi cr0,r9,810
	beq cr0,_keyChanges_L187
	lwz r9,16(r31)
	cmpwi cr0,r9,811
	beq cr0,_keyChanges_L187
	lwz r9,16(r31)
...
_keyChanges_L186:
	mr r9,r30
	cmpwi cr0,r9,6
	bne cr0,_keyChanges_L188
	lwz r9,16(r31)
	cmpwi cr0,r9,1587
	beq cr0,_keyChanges_L189
	lwz r9,16(r31)
	cmpwi cr0,r9,1588
	beq cr0,_keyChanges_L189
	lwz r9,16(r31)
...
_keyChanges_L188:
	mr r9,r30
	cmpwi cr0,r9,6
	bne cr0,_keyChanges_L190
	lwz r9,16(r31)
	cmpwi cr0,r9,1590
	beq cr0,_keyChanges_L191
	lwz r9,16(r31)
	cmpwi cr0,r9,1591
	beq cr0,_keyChanges_L191
	lwz r9,16(r31)
...
_setLocal:
	...
	lwz r10,12(r31)
	cmpw cr0,r10,r9
	beq cr0,_keyChanges_L213
	lis r9,_bladeFlag@ha
	lwz r9,_bladeFlag@l(r9)
	lwz r10,12(r31)
	cmpw cr0,r10,r9
	bne cr0,_keyChanges_L214
_keyChanges_L213:
	li r3,28
	bl _hasPreciousItem
	mr r9,r3
