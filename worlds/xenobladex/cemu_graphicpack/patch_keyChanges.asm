...
_getFlagValAdjusted:
	...
	mr r9,r30
	cmpwi cr0,r9,2
	bne cr0,_keyChanges_L121
	lwz r9,16(r31)
	cmpwi cr0,r9,246
	beq cr0,_keyChanges_L122
	lwz r9,16(r31)
	cmpwi cr0,r9,251
	beq cr0,_keyChanges_L122
	lwz r9,16(r31)
