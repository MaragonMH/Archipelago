...
friends_hb_regions: List[Rule] = generate_friend_region("H.B.")
...
friends_yelv_regions: List[Rule] = generate_friend_region("Yelv")
friends_boze_regions: List[Rule] = generate_friend_region("Boze")
...
friends_alexa_regions: List[Rule] = generate_friend_region("Alexa")
