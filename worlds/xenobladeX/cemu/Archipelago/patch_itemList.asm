...
_itemList_L12:
        ...
        lwz r3,132(r31)
        crxor 6,6,6
        lis r12, after_itemList__sprintf_s@ha
		addi r12,r12,after_itemList__sprintf_s@l
		mtlr r12
		lis r12,__sprintf_s@ha
		addi r12,r12,__sprintf_s@l
		mtctr r12
		bctr
after_itemList__sprintf_s:
        mr r9,r3
        mr r10,r9
        lwz r9,132(r31)
        add r9,r9,r10
...
_itemList_L14:
        ...
        lwz r3,132(r31)
        crxor 6,6,6
        lis r12, after_itemList1__sprintf_s@ha
		addi r12,r12,after_itemList1__sprintf_s@l
		mtlr r12
		lis r12,__sprintf_s@ha
		addi r12,r12,__sprintf_s@l
		mtctr r12
		bctr
after_itemList1__sprintf_s:
        mr r9,r3
        mr r10,r9
        lwz r9,132(r31)
        add r9,r9,r10
